...
?>
<style type="text/css">
.sp_login-button{background-image:url(http://static.ak.fbcdn.net/rsrc.php/v2/y6/x/S-DbSHszr4D.png);background-repeat:no-repeat;display:inline-block;height:18px;width:18px}
...
.pluginFaviconButtonIcon, .pluginFaviconButtonIconActive, .pluginFaviconButtonIconThrobber, .pluginFaviconButtonIconThrobber .img, .pluginFaviconButtonIconDisabled{vertical-align:top;background-color:#4f6aa3}
...
.sx_login-button_small{background-position:-0px -178px}
.sx_login-button_smalla{background-position:-19px -178px}
.sx_login-button_medium{width:22px;height:22px;background-position:-0px -132px}
.sx_login-button_mediuma{width:22px;height:22px;background-position:-0px -155px}
.sx_login-button_large{width:25px;height:25px;background-position:-0px -80px}
.sx_login-button_largea{width:25px;height:25px;background-position:-0px -106px}
...
.fwb{font-weight:bold}
                        	...
                        	<div class="pluginLoginButton pluginLoginButtonLarge" id="fbbtn01">
                        		<div>
                                	<div class="pluginFaviconButton pluginFaviconButtonEnabled pluginFaviconButtonLarge" id="u_0_0">
                                    	<table class="uiGrid" cellspacing="0" cellpadding="0">
                                        	<tbody>
                                            	<tr>
                                                	<td>
                                                    	<i class="pluginFaviconButtonIcon img sp_login-button sx_login-button_large"></i>
                                                        <i class="pluginFaviconButtonIconActive img sp_login-button sx_login-button_largea"></i>
                                                        <span class="pluginFaviconButtonIconThrobber"><i class="img sp_login-button sx_login-button_"></i></span>
													</td>
                                                    <td>
                                                    	<span class="pluginFaviconButtonBorder">
                                                        	<span class="pluginFaviconButtonText fwb" style="font-family:'lucida grande',tahoma,verdana,arial,sans-serif;color:#fff;">Log In with Facebook</span>
														</span>
													</td>
												</tr>
											</tbody>
